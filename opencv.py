...
# -------------------------------------------------------------------
# GESTOS CON LA NUEVA ESTRUCTURA (lm es lista de 21 landmarks de Tasks)
# -------------------------------------------------------------------
def get_palm_normal(lm):
    """Normal de la palma (0,5,17) usando 3D proporcionado por Tasks."""
...
with HandLandmarker.create_from_options(options) as landmarker:
    while True:
        ...
        # enviar frame a MediaPipe Tasks
        ...
        if last_result and last_result.hand_landmarks:
            for hand_idx, hand_lm in enumerate(last_result.hand_landmarks):
                ...
                # inicializar gestos persistentes
                ...
                # dedos que definen el bounding por gesto
                if shape == "index":
                ...
                # resetear contador de frames perdidos
        ...
        # gestionar manos no detectadas en este frame
        ...
        cv2.imshow("MediaPipe Gestos - Envío a Godot (Tasks + 3D)", frame)
